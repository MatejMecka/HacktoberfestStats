...
function getUserInfo(username: string, callback?: Callback<GitHubUser>): Promise<GitHubUser> | void {
 ...
 */
const _transformHacktoberfestResult = (minPullRequest: number) => (
  statsInfo: GitHubSearchResponse
): HacktoberfestStats => ({
...
function getHacktoberfestStats(username: string, year: number, callback: Callback<HacktoberfestStats>): void
